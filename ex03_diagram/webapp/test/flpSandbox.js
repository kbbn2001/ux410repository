		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#student02saptrainingdiagram-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student02saptrainingdiagram-display": {
								"semanticObject": "student02saptrainingdiagram",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student02.sap.training.diagram",
									"url": sap.ui.require.toUrl("student02/sap/training/diagram")
								}
							}
						}
					}
