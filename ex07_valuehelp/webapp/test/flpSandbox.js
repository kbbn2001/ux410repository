		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#student02saptrainingvaluehelp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student02saptrainingvaluehelp-display": {
								"semanticObject": "student02saptrainingvaluehelp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student02.sap.training.valuehelp",
									"url": sap.ui.require.toUrl("student02/sap/training/valuehelp")
								}
							}
						}
					}
