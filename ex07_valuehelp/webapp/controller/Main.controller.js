sap.ui.define([
    ...
    function (Controller,Filter,FilterOperator,Fragment) {
        ...
        return Controller.extend("student02.sap.training.valuehelp.controller.Main", {
            ...
            onValueHelpRequest: function (oEvent) {
                ...
                if (!this._oValueHelpDialog) {
                    Fragment.load({
                        name: "student02.sap.training.valuehelp.view.CarrierSelectionDialog",
                        controller: this
            ...
            _createFlightsTable : function(sPath) {
			    ...
			    Fragment.load({
                    ...
                    name: "student02.sap.training.valuehelp.view.Flights",
                    controller: this                    
                }).then (function(oFragment) {
