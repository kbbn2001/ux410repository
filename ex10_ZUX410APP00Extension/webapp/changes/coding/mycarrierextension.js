		...
		return ControllerExtension.extend("customer.ZUX410APP00Extension.mycarrierextension", {
            ...
            override : {
                onShowCarrierData : function(oEvent) {
                    MessageBox.show("You are currently viewing the data of carrier " + this.getView().getBindingContext().getProperty("Carrname"), {
			...
			// 	 * @memberOf customer.ZUX410APP00Extension.mycarrierextension
			// 	 */
			// 	onInit: function() {
			// 	},
