sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("student02.sap.training.dynamicpage.controller.Carrier", {
			...
			onShowCarrierData : function(){
                alert("You are currently viewing the data from carrier " + this.getView().getBindingContext().getProperty("Carrname"));
            }
